...
/**
 * Full-page view of a station's last 48 h: six time-aligned line charts (one per
 * variable) sharing a hover crosshair via ApexCharts' `chart.group`. Opened as a
 * full-screen `MatDialog`. Consumes the single bundled payload — reused from the
 * popover when provided, otherwise fetched once here.
 */
@Component({
