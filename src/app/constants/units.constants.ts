...
export const DISTANCE_UNITS = {
  KILOMETERS: 'km',
  METERS: 'm',
  GEOPOTENTIAL_METERS: 'gpm', // Altura geopotencial y espesor de capa
} as const;
...
export const WRF_UNITS = {
  ...
  HAIL_DIAMETER: PRECIPITATION_UNITS.CENTIMETERS,
  MUCAPE: 'J/kg',
  SEA_LEVEL_PRESSURE: WEATHER_STATION_UNITS.PRESSURE,
  DIMENSIONLESS: '',
} as const;

export const GFS_UNITS = {
  WIND_SPEED: WIND_SPEED_UNITS.KNOTS,
  SEA_LEVEL_PRESSURE: WEATHER_STATION_UNITS.PRESSURE,
  TEMPERATURE: TEMPERATURE_UNITS.CELSIUS,
  GEOPOTENTIAL: DISTANCE_UNITS.GEOPOTENTIAL_METERS,
} as const;
