...
Esta sección describe los cuatro componentes como unidades de despliegue. La estructura interna se
incluye cuando modifica el arranque, el consumo de recursos, la persistencia o la recuperación ante
una falla.
