...
La exposición del sistema depende de los puertos publicados y de los controles que aplica cada ruta.
Las tablas distinguen el estado actual de la configuración recomendada para una red operativa.
