...
Esta sección está escrita para quien tiene que decidir **si este sistema puede desplegarse en su red
y qué hay que cambiar antes**. No parte del supuesto de que el sistema es seguro. Parte de lo que
efectivamente hace, incluidas las cosas que hoy no protege. Todo lo que sigue se volvió a verificar
contra el código el 8 de septiembre de 2026.
