...
El consumo depende principalmente de los productos activos y de la cantidad de trabajos que los
workers procesan al mismo tiempo. El perfil [Beta-1](beta-1.md) se mantuvo por debajo de 8 GB durante
las mediciones del equipo. Esa observación deja de ser válida si se agregan productos, workers o una
carga distinta de la utilizada en la prueba.
...
| Descarga en flujo a disco | No corresponde | Los archivos grandes no se cargan enteros |
...
Es el único con control de admisión explícito, y sus límites llegan al usuario como respuestas.
