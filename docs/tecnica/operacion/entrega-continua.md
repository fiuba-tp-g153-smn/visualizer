...
1. POST al webhook de despliegue con un token bearer, con un tope de 30 segundos.
...
Ver [Despliegue e infraestructura](../operacion/despliegue.md) para la topología, y
[Pruebas y calidad](calidad.md) para el detalle de las suites.
