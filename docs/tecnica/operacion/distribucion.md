...
La instalación actual concentra los componentes en una sola máquina. Es posible separar parte del
sistema, aunque las plantillas y los volúmenes todavía conservan varias dependencias con el host. Las
alternativas de este capítulo describen los cambios necesarios y señalan aquello que aún no fue
