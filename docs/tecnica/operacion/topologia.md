...
Los cuatro componentes conservan redes de Compose separadas. El tráfico que cruza de una a otra
utiliza un puerto publicado en el host, mientras que las fuentes locales ingresan por carpetas
montadas. Esta disposición determina qué reglas de red necesita el sistema y qué procesos deben
compartir una máquina.
