...
El recorrido de un producto comienza cuando el productor descubre un archivo y termina cuando el
navegador solicita una tesela. Entre ambos puntos, un worker procesa el dato, SeaweedFS conserva el
resultado y `data-service` lo incorpora a Redis. Cada etapa trabaja con su propia frecuencia y aplica
un criterio de reintento distinto.
