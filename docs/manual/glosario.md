...
Este glosario reúne los términos que utiliza la interfaz. Las definiciones de los productos indican
cómo aparecen en MapaSMN y no reemplazan su interpretación meteorológica.

![Cómo se relacionan los términos](../imgs/diagrams/glosario-conceptos.svg){ .diagram loading=lazy }

La capa es la unidad principal de la interfaz. El catálogo la presenta, la pestaña Activas permite
ordenarla y la sección Período controla su tiempo. La sincronización combina los períodos de varias
capas. Los avisos se dibujan sobre ellas, aunque pertenecen a otro flujo de trabajo.
...
HOA y UTC
:   Las dos zonas horarias de la aplicación. HOA es UTC-3 durante todo el año.
