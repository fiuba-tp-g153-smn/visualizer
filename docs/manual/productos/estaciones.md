...
El grupo Estaciones meteorológicas presenta siete variables de la red de observación de superficie
del SMN. El mapa muestra una variable por vez y representa cada estación mediante un marcador cuyo
color depende del valor informado.
...
observación, marcada de fábrica, deja en el mapa las que no reportaron.
