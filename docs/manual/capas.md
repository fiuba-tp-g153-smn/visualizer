...
MapaSMN organiza como capas toda la información que dibuja sobre el mapa. El panel Capas del mapa
permite seleccionar los productos, ordenar los que se encuentran activos y ajustar su representación.

![Del catálogo al mapa](../imgs/diagrams/capas-modelo.svg){ .diagram loading=lazy }

El panel contiene tres pestañas. Disponibles presenta el catálogo completo y Activas reúne lo que el
usuario incorporó al mapa. Sincronización permite animar varias capas sobre una misma línea de tiempo,
como se explica en el [capítulo 5](animacion.md). Las dos últimas pestañas indican, mediante un número,
cuántas capas participan en cada caso.
...
Arriba hay un buscador (1) que filtra el catálogo completo por nombre, desde dos letras.
Debajo, los cinco grupos, empezando por Satélite (2):
