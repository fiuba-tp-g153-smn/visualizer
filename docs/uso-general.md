...
![Interfaz Principal de Visualizador](./imgs/uso-general/main-ui.png){ .doc-figure loading=lazy style="max-height: 400px" }
...
![Mapas base](./imgs/uso-general/mapas-base.png){ .doc-figure loading=lazy style="max-height: 500px" }

### Capas Meteorológicas { #capas-meteorologicas }

Una vez seleccionado el desplegable de capas del mapa se observan las fuentes de datos disponibles:

![Fuentes de Datos Disponibles](./imgs/uso-general/capas-1-fuentes-de-datos.png){ .doc-figure loading=lazy style="max-height: 450px" }

Al desplegar las fuentes de datos se observan agrupaciones de productos/capas:

![Agrupación de Capas por Categoría](./imgs/uso-general/capas-2-agrupacion-de-capas.png){ .doc-figure loading=lazy style="max-height: 450px" }
...
![Selección de Productos Individuales](./imgs/uso-general/capas-3-productos-individuales.png){ .doc-figure loading=lazy style="max-height: 450px" }
...
![Capa Activa Seleccionada](./imgs/uso-general/capas-4-capas-activas.png){ .doc-figure loading=lazy style="max-height: 450px" }
...
![Configuración de Opacidad](./imgs/uso-general/capas-5-configuracion-opacidad.png){ .doc-figure loading=lazy style="max-height: 450px" }
...
![Controles de Animación de Capa](./imgs/uso-general/capas-6-configuracion-animacion.png){ .doc-figure loading=lazy style="max-height: 450px" }
...
![Navegación del mapa](./imgs/uso-general/navegacion-mapa.png){ .doc-figure loading=lazy style="max-height: 450px" }

## Capas Activas (Control de Capas)

Al seleccionar la sección de capas activas se despliegan las capas activas:

![Capas Activas](./imgs/uso-general/capas-activas.png){ .doc-figure loading=lazy style="max-height: 300px" }
...
![Z-Index Canal 9 encima de Canal 13](./imgs/uso-general/z-index-1.png){ .doc-figure loading=lazy style="max-height: 450px" }

Ejemplo del Canal 13 encima del Canal 9:

![Z-Index Canal 13 encima de Canal 9](./imgs/uso-general/z-index-2.png){ .doc-figure loading=lazy style="max-height: 450px" }
